            ...
            <v-list dense>
                ...
                <v-list-item-group 
                    ...
                    <v-list-item
                        ...
                        <v-list-item-content>
                            <v-list-item-title style="font-size:medium;padding:5px;">Audit</v-list-item-title>
                        </v-list-item-content>
                    </v-list-item>
                </v-list-item-group>
            </v-list>
...
export default {
    name: "Dashboard",
        data() {
            ...
            reporting: [
                { title: "RPTI", icon:"mdi-book-open-variant", to: "/repRPTIGov"},
                { title: "Revisi RPTI", icon:"mdi-ballot-recount-outline", to: "/repRevisiGov"},
                { title: "Insertion", icon:" mdi-finance", to: "/repInsertionGov"},
                { title: "Audit", icon:"mdi-chart-bar", to: "/repAuditGov"}
            ],
            mini: true,
            username: null,
        };
